              ...
              {threadsProducts.map((product) => (
                ...
                >
                  <div className="card-luxury aspect-[3/4] overflow-hidden relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 flex flex-col">
                      ...
                      <p className="mt-1 sm:mt-2 font-body text-xs sm:text-sm text-muted-foreground line-clamp-2">
