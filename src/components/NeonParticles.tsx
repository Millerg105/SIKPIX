  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((particle) => {
        ...
        gradient.addColorStop(0, `hsla(120, 100%, 60%, ${currentOpacity})`);
        gradient.addColorStop(0.5, `hsla(120, 100%, 50%, ${currentOpacity * 0.5})`);
        gradient.addColorStop(1, `hsla(120, 100%, 40%, 0)`);
